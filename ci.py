...
if __name__ == "__main__" :
                ...
                label5 = Label(root, text = "Author: Chinthala Vijaya Kumar ",
                                        fg = 'black', bg = 'orange')

                label6=Label(root,text="Computer Science Department",
                                        fg='black',bg='orange')
                ...
                label6.grid(row=7,column=0,padx=2,pady=2)
